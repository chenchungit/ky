...
function talk(luaMgr, client, params)
  return "\n"
  .."<font color=\"#eefe2c\">记录1. <font color=\"#ffffff\">名称:" 
  .. luaMgr:GetMapRecordMapName(client, 1) .. "  坐标:" .. luaMgr:GetMapRecordXY(client, 1) 
  .. "\n\n              <font color=\"#00ff00\"><a class=\"myunderline\" href=\"event:_talk_dwjl1\">记录当前坐标</a>  <a class=\"myunderline\" href=\"event:talk_fwzb1\">飞往记录坐标</a> \n\n"
  .."<font color=\"#eefe2c\">记录2. <font color=\"#ffffff\">名称:" 
  .. luaMgr:GetMapRecordMapName(client, 2) .. "  坐标:" .. luaMgr:GetMapRecordXY(client, 2) 
  .. "\n\n              <font color=\"#00ff00\"><a class=\"myunderline\" href=\"event:_talk_dwjl2\">记录当前坐标</a>  <a class=\"myunderline\" href=\"event:talk_fwzb2\">飞往记录坐标</a>\n\n<font color=\"#ff0000\">"
  .."<font color=\"#eefe2c\">记录3. <font color=\"#ffffff\">名称:" 
  .. luaMgr:GetMapRecordMapName(client, 3) .. "  坐标:" .. luaMgr:GetMapRecordXY(client, 3) 
  .. "\n\n              <font color=\"#00ff00\"><a class=\"myunderline\" href=\"event:_talk_dwjl3\">记录当前坐标</a>  <a class=\"myunderline\" href=\"event:talk_fwzb3\">飞往记录坐标</a>\n\n<font color=\"#ff0000\">"
  .."<font color=\"#eefe2c\">记录4. <font color=\"#ffffff\">名称:" 
  .. luaMgr:GetMapRecordMapName(client, 4) .. "  坐标:" .. luaMgr:GetMapRecordXY(client, 4) 
  .. "\n\n              <font color=\"#00ff00\"><a class=\"myunderline\" href=\"event:_talk_dwjl4\">记录当前坐标</a>  <a class=\"myunderline\" href=\"event:talk_fwzb4\">飞往记录坐标</a>\n\n<font color=\"#ff0000\">"
  .."<font color=\"#eefe2c\">记录5. <font color=\"#ffffff\">名称:" 
  .. luaMgr:GetMapRecordMapName(client, 5) .. "  坐标:" .. luaMgr:GetMapRecordXY(client, 5) 
  .. "\n\n              <font color=\"#00ff00\"><a class=\"myunderline\" href=\"event:_talk_dwjl5\">记录当前坐标</a>  <a class=\"myunderline\" href=\"event:talk_fwzb5\">飞往记录坐标</a>\n\t\n"
end
