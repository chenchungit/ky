...
namespace Server.Data
{
    ...
    public class SpriteNotifyOtherMoveData : IProtoBuffData
    {
        ...
        public int fromBytes(byte[] data, int offset, int count)
        {
            ...
            for (; mycount < count; )
            {
                ...
                switch (fieldnumber)
                {
                    ...
                    case 12: this.targetRoleID = ProtoUtil.LongMemberFromBytes(data, wt, ref pos, ref mycount); break;
                    default:
                        {
        ...
        public byte[] toBytes()
        {
            ...
            total += ProtoUtil.GetLongSize(targetRoleID, true, 12);
            ...
            ProtoUtil.LongMemberToBytes(data, 12, ref offset, targetRoleID);
            return data;
        }
