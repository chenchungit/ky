...
namespace GameServer.Server.CmdProcesser
{
    ...
    public class CmdRegisterTriggerManager : IManager
    {
        ...
        {
            TriggerProcessor(ZhanMengBuildUpLevelCmdProcessor.getInstance());
            TriggerProcessor(ZhanMengBuildGetBufferCmdProcessor.getInstance());
            TriggerProcessor(WingOffOnCmdProcessor.getInstance());
            TriggerProcessor(WingUpgradeCmdProcessor.getInstance());
            TriggerProcessor(WingUpStarCmdProcessor.getInstance());
            TriggerProcessor(GetWingInfoCmdProcessor.getInstance());
