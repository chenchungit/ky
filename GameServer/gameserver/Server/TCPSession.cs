...
namespace GameServer.Server
{
    public class TCPSession
    {
        ...
        public static int MaxPosCmdNumPer5Seconds = GameManager.PlatConfigMgr.GetGameConfigItemInt(PlatConfigNames.MaxPosCmdNum, 8);
        /// <summary>
        /// 重新加载配置文件PlatConfig.xml后，需要重新设置MaxPosCmdNumPer5Seconds，如果配置文件中没有配置相关选项，则使用defVal
        /// </summary>
        /// <param name="defVal"></param>
        public static void SetMaxPosCmdNumPer5Seconds(int defVal)
        {
           MaxPosCmdNumPer5Seconds=GameManager.PlatConfigMgr.GetGameConfigItemInt(PlatConfigNames.MaxPosCmdNum, defVal);
        }
