...
namespace CC
{
    ...
    public enum CommandID
    {
      ...
      [global::ProtoBuf.ProtoEnum(Name=@"CMD_SYS_ERRCODEMSG", Value=16998)]
      CMD_SYS_ERRCODEMSG = 16998,
            
      [global::ProtoBuf.ProtoEnum(Name=@"CMD_SYS_ERRCODE", Value=16999)]
      CMD_SYS_ERRCODE = 16999
    }
    ...
    public enum ErrorCode
    {
      ...
      [global::ProtoBuf.ProtoEnum(Name=@"ERROR_OTHERERR", Value=15)]
      ERROR_OTHERERR = 15,
            
      [global::ProtoBuf.ProtoEnum(Name=@"ERROR_MAP_CHANGE_NOTINELEPORTDICT", Value=50)]
      ERROR_MAP_CHANGE_NOTINELEPORTDICT = 50,
            
      [global::ProtoBuf.ProtoEnum(Name=@"ERROR_MAP_CHANGE_NOMAP", Value=51)]
      ERROR_MAP_CHANGE_NOMAP = 51,
            
      [global::ProtoBuf.ProtoEnum(Name=@"ERROR_MAP_CHANGE_NOTOMAP", Value=52)]
      ERROR_MAP_CHANGE_NOTOMAP = 52,
            
      [global::ProtoBuf.ProtoEnum(Name=@"ERROR_MAP_CHANGE_NOTELEPORTDICT", Value=53)]
      ERROR_MAP_CHANGE_NOTELEPORTDICT = 53,
            
      [global::ProtoBuf.ProtoEnum(Name=@"ERROR_MAP_CHANGE_LOWCHANGELIFE", Value=54)]
      ERROR_MAP_CHANGE_LOWCHANGELIFE = 54,
            
      [global::ProtoBuf.ProtoEnum(Name=@"ERROR_MAP_CHANGE_LOWLEVEL", Value=55)]
      ERROR_MAP_CHANGE_LOWLEVEL = 55
    }
