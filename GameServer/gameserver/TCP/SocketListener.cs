    ...
    public sealed class SocketListener
    {
        ...
        private void CloseClientSocket(SocketAsyncEventArgs e, string reason)
        {
            ...
            try
            {
                ...
                LogManager.WriteLog(LogTypes.Error, string.Format("远程连接关闭: {0}, 当前总共: {1}, 原因1:{2}, 原因2:{3}", ip, ConnectedSocketsCount, reason, s.CloseReason));
                CloseSocket(s);
            }
            finally
            {
        ...
        private void OnAcceptCompleted(object sender, SocketAsyncEventArgs e)
        {
            ...
            {
                //SysConOut.WriteLine(string.Format("在SocketListener::OnAcceptCompleted 中发生了异常错误"));
        ...
        private void OnIOCompleted(object sender, SocketAsyncEventArgs e)
        {
            try
            {
                ...
                switch (e.LastOperation)
                {
                    case SocketAsyncOperation.Receive:
                       // SysConOut.WriteLine("SocketAsyncOperation.Receive");
                    ...
                    default:
                        {
                           // SysConOut.WriteLine("SocketAsyncOperation. default");
            ...
            {
               // SysConOut.WriteLine(string.Format("在SocketListener::OnIOCompleted 中发生了异常错误"));
        ...
        private bool _SendAsync(SocketAsyncEventArgs writeEventArgs, out bool exception)
        {
            ...
            {
               // SysConOut.WriteLine(string.Format("在SocketListener::_SendAsync 中发生了异常错误:{0}", ex.Message));
        ...
        {
            //SysConOut.WriteLine("ClearTimeoutSocket===========================");
            bool ret = false;
