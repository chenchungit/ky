...
namespace GameServer.Logic.LoginWaiting
{
    public class LoginWaitLogic
    {
        ...
        {
            string strCfg = GameManager.PlatConfigMgr.GetGameConfigItemStr(PlatConfigNames.UserWaitConfig, "700,1000,400,30000,180000,20000");
            m_IntConfig[(int)UserType.Normal] = Global.String2IntArray(strCfg);
            strCfg = GameManager.PlatConfigMgr.GetGameConfigItemStr(PlatConfigNames.VipWaitConfig, "900,1000,400,30000,180000,20000");
