...
namespace GameServer.Logic
{
    ...
    public class DBCmdManager
    {
        ...
        public void AddDBCmd(int cmdID, byte []CmdData, DBCommandEventHandler dbCommandEvent, int serverId)
        {
            Global.ExecuteDBCmd(cmdID, CmdData, serverId);
            return;
