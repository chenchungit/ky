...
namespace GameServer.Logic
{
    ...
    public class GameManager
    {
        ...
        /// 地图障碍物格子宽度
        /// </summary>
        public static int MapGridWidth = 80;

        /// <summary>
        /// 地图障碍物格子高度
        /// </summary>
        public static int MapGridHeight = 80;
        ...
        /// </summary>
        public static bool TestGamePerformanceMode = true;
        ...
        /// 职业对应角色移动速度的配置管理类
        /// </summary>
        public static GlobalDefultOccTimeManager DefultOccTimeMgr = new GlobalDefultOccTimeManager();
        /// <summary>
        ...
        public static ch.Logic.ErrManager ErrMgr = new ch.Logic.ErrManager();
        #endregion 全局对象
        ...
        /// 默认角色数据配置表
        /// </summary>        
        public static GlobalDefultManager SystemGlobalDefultMgr = new GlobalDefultManager();
        /// <summary>
        /// 任务列表管理对象
        /// </summary>        
        public static SkillManager SystemSkillMgr = new SkillManager();
        //================================================cc
...
//         public static SystemXmlItems SystemShengWangLevel = new SystemXmlItems();
        ...
        /// </summary>
        public static ServerEvents SystemRoleStoreYinLiangEvents = new ServerEvents() { EventRootPath = "RoleEvents", EventPreFileName = "StoreYinLiang" };
