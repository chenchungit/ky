...
namespace GameServer.Logic
{
    ...
    public enum OpTags
    {
        ...
        LuoLanChengZhanDailyAwards = 100,//罗兰城战每日奖励,
        LangHunLingYu,//狼魂领域
        LangHunLingYuDailyAwards,//狼魂领域

        ExecuteChangeLifeCount = 200, //转生
        ChengJiu,//成就系统,
        QingGongYan,//举办庆功宴,
        ShenQiZaiZao,//神器再造,
        Building, //领地
    ...
    /// <summary>
    /// 日志记录格式定义，格式应当以注释形式备注在枚举后面
    /// 日志的前几个部分是固定的，不需在下面附加注释：
    /// 时间 LogRecordType数字形式 SeverId UserId RoleId
    /// </summary>
    public enum LogRecordType
    {
        ...
        QueryServerTotalUserMoney = 10000, // 查询当前服务器总计钻石数
    }
